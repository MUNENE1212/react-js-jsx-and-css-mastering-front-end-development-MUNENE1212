 ...
 * Footer Component
 *
 * Application footer with navigation links, social media links,
 * and copyright information.
 *
 * Features:
 * - Responsive grid layout
 * - Multiple footer sections (About, Quick Links, Connect)
 * - Social media icons
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm">
              ...
              and JSONPlaceholder API. Demonstrating component architecture,
        ...
        <div className="pt-8 border-t border-gray-200 dark:border-gray-700">
          <p className="text-center text-gray-600 dark:text-gray-400 text-sm">
            © {currentYear} PLP Task Manager. Built with ❤️ for learning React and
            Tailwind CSS.
          </p>
        </div>
      </div>
